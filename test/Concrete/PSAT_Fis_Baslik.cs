...
namespace test.Concrete
{
    ...
    public partial class PSAT_Fis_Baslik
    {
        ...
        public Nullable<double> Satis_Tutari1 { get; set; }
        public Nullable<double> Satis_Tutari2 { get; set; }
        public Nullable<double> Odeme_Tutari1 { get; set; }
        public Nullable<double> Odeme_Tutari2 { get; set; }
